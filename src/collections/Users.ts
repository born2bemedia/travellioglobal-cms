      ...
      generateEmailHTML: (args?: { token?: string }) => {
        ...
        return `
          <div style="background-color: white;font-family: sans-serif; line-height: 1.5;width:640px;margin:0 auto;">
            <img src="${process.env.WEB_FRONT_URL}/images/email-header.png" alt="Axelvior Logo" style="width: 100%; height: auto;" />
...
">Reset Password</a></p>
            ...
            <img src="${process.env.WEB_FRONT_URL}/images/email-footer.png" alt="Axelvior Logo" style="width: 100%; height: auto;" />
          </div>  
        `;
      },
    },
